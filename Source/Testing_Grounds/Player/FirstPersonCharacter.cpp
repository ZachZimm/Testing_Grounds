...
void AFirstPersonCharacter::BeginPlay()
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("RifleBlueprint is set to NULL!"))
		return;
	}
...
void AFirstPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("Fire", IE_Pressed, Rifle, &ARifle::OnFire);
...
//				World->SpawnActor<ABouncingBall_Projectile>(ProjectileClass, SpawnLocation, SpawnRotation);
//			}
//			else
//			{
